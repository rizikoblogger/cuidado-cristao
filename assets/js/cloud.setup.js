...
Cloud.setup({
  ...
  methods: {
    ...
    'removeUserClasse': {
      'verb': 'DELETE',
      'url': '/api/v1/classe/remove-user-classe',
      'args': ['userId', 'classroomId']
    },
    'saveUserChurch': {'verb': 'POST', 'url': '/api/v1/church/save-user-church', 'args': ['userId', 'churchId']},
    'saveSermon': {
      'verb': 'POST',
      'url': '/api/v1/sermon/save-sermon',
      'args': ['id', 'titulo', 'comentario', 'videoUrl', 'church']
    },
    'saveResource': {
      'verb': 'POST',
      'url': '/api/v1/resource/save-resource',
      'args': ['id', 'tipo', 'name', 'detail', 'location', 'church']
    },
    'saveUser': {
      'verb': 'POST',
      'url': '/api/v1/user/save-user',
      'args': ['id', 'emailAddress', 'fullName', 'isSuperAdmin', 'church', 'userCares', 'socialServices', 'contributions', 'classrooms']
    }
  }
  /* eslint-enable */
